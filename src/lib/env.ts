export const ENV = {
  ...
  EAS: (import.meta.env.VITE_EAS_ADDRESS || '0xb101275a60d8bfb14529C421899aD7CA1Ae5B5Fc') as `0x${string}`,
  REGISTRY: (import.meta.env.VITE_SCHEMA_REGISTRY || '0x23c5701A1BDa89C61d181BD79E5203c730708AE7') as `0x${string}`,
  SCHEMA_UID: (import.meta.env.VITE_POLYSEAL_SCHEMA_UID || '0x27d06e3659317e9a4f8154d1e849eb53d43d91fb4f219884d1684f86d797804a') as `0x${string}`,
